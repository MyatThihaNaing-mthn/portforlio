    ...
    return (
        <div className=" left-panel ">
            <ul className=" social-links-list">
                <li>
                    <a href="https://github.com/MyatThihaNaing-mthn" target="_blank" rel="noopener">
                ...
                <li>
                    <a href="https://www.linkedin.com/in/myat-thiha-naing/" target="_blank" rel="noopener">
                ...
                <li>
                    <a href="https://www.facebook.com/myatthihanai" target="_blank" rel="noopener">
                        <svg xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" width="24" height="24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="feather feather-facebook">
                ...
                <li>
                    <a href="https://x.com/myat_thiha7" target="_blank" rel="noopener">
